...
# Path: ~metno_op/atmos/harmonie/job/scripts
#==============================================================================
#
...
# Needed for build, but not for run:
# netcdf/4.3.2-i1501-impi-5.0.2.044-hdf5-1.8.14
# buildenv-intel/2015-1
# END Load necessary modules
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:~/opt/grib_api-1.13.1p1/lib/:~/opt/boost_1.58/lib/
...
# Get times
DTG=$( ls /home/cooper/run/AM25_oper/fc*${utc}+000grib )
...
for time in ${times//,/ }; do
  ...
  { 
    gribfile=/home/cooper/run/AM25_oper/fc$yyyy$mm$dd$hh+0${time}grib
